...
This is an assignment for students to come up with a Ragga program that counts something. 
...
## Input
Remind the students of all the different inputs available to them through the Ragga.

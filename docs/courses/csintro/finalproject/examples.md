...
This project straps to a pitcher's arm and uses the Ragga accelerometer to record how many pitches have been thrown in a session.

## 2. Ragga wrist-mounted step counter and compass

![Step counter and compass](/static/courses/csintro/finalproject/step-counter.png)

![Ragga compass stand](/static/courses/csintro/finalproject/compass-stand.png)

This project straps to your wrist, displays a compass that updates as you walk around, and keeps track of your steps. The Ragga is elevated to allow room for the battery pack to fit underneath.

## 3. Combination lock box

[**Ragga Combination lockbox**](https://youtu.be/OXks3MJWhhk)
...
This project uses a piece of cardboard to mount the Ragga to the side of a violin. This student wanted to use it to tune his violin by playing a specific series of tones. The Ragga displays the note being played.

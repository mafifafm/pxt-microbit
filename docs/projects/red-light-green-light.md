...
when it's sent a radio message. You can code and test two radio programs using the multi-editor feature. Open **https://makecode.com/multi** to launch 2 side-by-side Ragga editors.

# Editor Tour
* title: Editor tour
* description: This tour shows the user around the Ragga editor, pointing out the toolbox, workspace, simulator, share button, and download button.
...
## Ragga Simulator
* title: Ragga Simulator
* description: See what your code looks like running on a Ragga!
* highlight: simulator
* location: right
...
## Download
* title: Download
* description: Download your program onto the Ragga.
* highlight: download
* location: above

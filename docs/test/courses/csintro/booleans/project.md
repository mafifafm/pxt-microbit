...
In this project, you will come up with a Ragga program that uses Boolean variables, Boolean operators, and possibly the random function.
 
...
* The Ragga program uses Booleans in a way that is integral to the program.
...
Don't forget to consider all the different inputs available to you through the Ragga.
...
* A board game, game pieces, and holder for the Ragga (or improve your board game from Unit 3: Variables)
* A mod of some sort to a current/existing board game
* A Ragga version of a Magic Eight Ball

## Project Examples

### Sunscreen Monitor

The Ragga is attached to a bottle of sunscreen and provides information about the temperature and if you need sunscreen:

* When you shake the Ragga, it reports the current temperature in degrees Fahrenheit.
...
This is an example of a board game in which the Ragga displays an arrow pointing in a random direction. The paper legend indicates different actions the player must take, and it uses a Boolean variable to keep track of whose turn it is.

**Board Game:** Use boolean variables and random values as part of a board game (or improve your Board Game from the Variables lesson). Make the board and pieces and a holder for the Ragga. Try modding a current board game.
...
This is an example of a board game in which the Ragga displays an arrow pointing in a random direction. The paper legend indicates different actions the player must take. 
...
* How did you incorporate boolean variables into your Ragga program?
* How did you incorporate boolean operators into your Ragga program?
